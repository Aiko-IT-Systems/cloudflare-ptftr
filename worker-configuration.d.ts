/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6fe718ef315489eed2bd0219ebc17e1e)
// Runtime types generated with workerd@1.20250813.0 2025-08-16 
declare namespace Cloudflare {
	interface Env {
		ENABLE_DEV: false;
		PATREON_ACCOUNT: "https://www.patreon.com/aiko_it_systems";
		REMOTE_STORE_ID: "766810d8e2c04f1ca24dcc45253af39e";
		DISCORD_CLIENT_ID: SecretsStoreSecret;
		DISCORD_CLIENT_SECRET: SecretsStoreSecret;
		DISCORD_TOKEN: SecretsStoreSecret;
		PATREON_CLIENT_ID: SecretsStoreSecret;
		PATREON_CLIENT_SECRET: SecretsStoreSecret;
		PATREON_CREATOR_ACCESS_TOKEN: SecretsStoreSecret;
		PATREON_CREATOR_REFRESH_TOKEN: SecretsStoreSecret;
		DISCORD_GUILD_ID: SecretsStoreSecret;
		DISCORD_ROLE_ID: SecretsStoreSecret;
		PATREON_FREE_TIER_ID: SecretsStoreSecret;
	}
}
